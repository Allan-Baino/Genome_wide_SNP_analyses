...
**Script 03**: lgsub.sh - This AWK script is designed to perform substitution of /_ / with ":" separating arguments on the header section of read 1 and 2 fastq files for all individuals. 
