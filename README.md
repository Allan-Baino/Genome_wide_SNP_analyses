...
**Script 07**: lcaMKDP.sh - This script is designed to locate and tag optical or PCR duplicates (technical artifacts from the PCR process) and, also technical replicates from sequencing library design (estimating discordance in genotypes called for the same sample - genotyping error).

**Script 08**: lcaMAPQ.sh - 
