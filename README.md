...
**Script 00**: lcafastQC.sh - This script performs standard illumina sequence quality checks https://www.bioinformatics.babraham.ac.uk/projects/fastqc/ with output in the form of .html reports for sequenced pools (2 lanes of 12 sample pools).
